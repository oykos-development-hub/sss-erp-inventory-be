...
INSERT INTO items (
   article_id, type, class_type_id, depreciation_type_id, supplier_id,
...
INSERT INTO items (
   type, class_type_id, depreciation_type_id, supplier_id,
   serial_number, inventory_number, title, abbreviation, internal_ownership,
   office_id, target_user_profile_id, unit, amount, net_price, gross_price,
   description, date_of_purchase,
   invoice_number, active, date_of_assessment,
...
INSERT INTO real_estates (
    item_id, title, type_id, square_area, land_serial_number,
...
VALUES
    (4, 'Zgrada', 'Zgrada', 500, 'LSN001', 'ESN001', 'Private', 'Scope 1', 'Investment Scope 1', 'No limitations', 'Limitation ID 1', 'Property Doc 1', 'Document 1', 201, NOW(), NOW()),
    (5, 'Livada', 'Livada', 1000, 'LSN002', 'ESN002', 'Public', 'Scope 2', 'Investment Scope 2', 'Limitations exist', 'Limitation ID 2', 'Property Doc 2', 'Document 2', 202, NOW(), NOW());
...
VALUES
    ('Outgoing', 2, 1, 4, 2, true, 'DS001', 27, 'Prenos izmedju sudova Niksic-Berane', 501, NOW(), NOW()),
    ('Incoming', 4, 2, 2, 1, true, 'DS002', 27, 'Prenos izmedju sudova Berane-NIksic', 502, NOW(), NOW()),
    ('Outgoing', 6, 5, null, 2, false, 'DS003', 28, 'Prenos IT-Berane', 503, NOW(), NOW());

--assessments, dodata je i jedna stara procjena i tri aktivne

INSERT INTO assessments (
	inventory_id, active, depreciation_type_id, user_profile_id, gross_price_new, gross_price_difference, date_of_assessment, created_at, updated_at, file_id
)
VALUES
    (3, true, 25, 3, 500, 200, '2023-01-15', NOW(), NOW(), 401),
    (4, true, 25, 3, 30000, 3000, '2023-02-20', NOW(), NOW(), 402),
    (5, true, 26, 4, 8000, 1000, '2023-03-10', NOW(), NOW(), 403),
    (5, false, 26,4, 9000, 1000, '2023-03-10', NOW(), NOW(), 403);

--dispatch_items

insert into dispatch_items(dispatch_id, inventory_id)
values
(1,1),
(1,2),
(1,3),
