...
func NewAssessmentHandler(app *celeritas.Celeritas, assessmentService services.AssessmentService, errorLogService services.ErrorLogService) AssessmentHandler {
